...
ASMP4 is a symbolic native assembler for the Plus/4.  Source
...
ASMP4 does a two-pass assembly.  While multiple linked
...
program is ML.  The source code for ASMP4 itself is also
provided, so you may revise the assembler as you like.

Included here are:

1. ASMP4.PRG - the executable assember.  Load and Run.
2. ASMP4.SC1 thru .SC3 - Source code for ASMP4.
3. ASMP4HLP.ASC, .PET, .SC - Instructions in Ascii, Petscii,
